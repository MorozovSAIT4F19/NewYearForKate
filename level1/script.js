...
let nextLetter = 0;
// загаданное слово
let rightGuessString = "билет"; //WORDS[Math.floor(Math.random() * WORDS.length)]
...
function checkGuess () {
    ...
    if (guessString === rightGuessString) {
        ...
        document.getElementsByTagName('body')[0].innerHTML += '<div id="notification"><p>Верно! Это билет - но в какое место?</p></div>';
        document.getElementsByTagName('body')[0].innerHTML += '<div id="next-level"><a href="https://morozovsait4f19.github.io/NewYearForKate/level2/">Это нужно угадать на следующем уровне</a></div>';
